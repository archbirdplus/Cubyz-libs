...
static GLFWbool initExtensions(void)
{
    ...
    _glfw.x11.vidmode.handle = _glfw_dlopen("libXxf86vm.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xi.handle = _glfw_dlopen("libXi.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.randr.handle = _glfw_dlopen("libXrandr.");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xcursor.handle = _glfw_dlopen("libXcursor.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xinerama.handle = _glfw_dlopen("libXinerama.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.x11xcb.handle = _glfw_dlopen("libX11-xcb.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xrender.handle = _glfw_dlopen("libXrender.dylib");
#else
